...
public class HISTORY_ACTIVITY extends AppCompatActivity implements DatePickerDialog.OnDateSetListener{

    private RecyclerView recyclerView;
    private Button search;
    private TextView historyTotalAmountSpent;
    private Today_items_adapter todayItemsAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        todayItemsAdapter = new Today_items_adapter(HISTORY_ACTIVITY.this, myDataList);
